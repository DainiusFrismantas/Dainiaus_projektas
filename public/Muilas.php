...
<body>
    ...
    <section class="hero-muilas">
        <div class="container">
            ...
            <h4>Rankų daro <b>muilas</b> gaminamas iš puikios kokybės žaliavos - sertifikuotos muilo bazės, pagamintos Izraelyje. Naudojamos balta, bespalvė, su pirmo spaudimo alyvuogių aliejum, su neapdoroto alyvuogių aliejaus tirščiais, su negyvosios jūros purvu muilo bazės.</h4> 
            <!-- Pirma nuotraukų eilė -->
            <div class="row">
                <!-- Prekė Nr. 1 -->
                <div class="mySlidesfade">
                    <img src="../app/images/Muilas1.png" alt = 'Muilas Nr.1'>
                ...
                <!-- Prekė Nr. 2 -->
                <div class="mySlidesfade">
                    <img src="../app/images/Muilas2.png" alt = 'Muilas Nr.2'>
                    <div class="price">3 € / 100 g</div>
                    <div class="buy"><button class="js-cd-add-to-cart" 
                        data-item-id="2"
                        data-price="3" 
            ...
            <!-- Prekė Nr. 3 -->
                <div class="mySlidesfade">
                    <img src="../app/images/Muilas3.png" alt = 'Muilas Nr.3'>
                    <div class="price">3 € / 100 g</div>
                    <div class="buy"><button class="js-cd-add-to-cart" 
                        data-item-id="3"
                        data-price="3" 
                ...
                <!-- Prekė Nr. 4 -->
                <div class="mySlidesfade">
                    <img src="../app/images/Muilas4.png" alt = 'Muilas Nr.4'>
                    <div class="price">3 € / 100 g</div>
                    <div class="buy"><button class="js-cd-add-to-cart" 
                        data-item-id="4"
                        data-price="3" 
            ...
            <h4>Išgauti spalvą ir kvapą naudojami dažai ir aliejai, skirti muilo ir kosmetikos gamybai.Nemėgstantiems kvapų ir spalvų gaminami bespalviai ir bekvapiai muilai su natūraliomis džiovintomis vaistažolėmis ir pievų gėlėmis.Išgauti drėkinamąjį ir švelnumo poveikį naudojami natūralūs avokado, linų sėmenų ir kanapių aliejai. Vienodo <b>muilo</b> čia nėra. </h4>
        </div>
</section>
        <?php 
