            ...
            <!-- Pirma nuotraukų eilė -->
                <div class="row">
                    ...
                    <div class="mySlidesfade">
                        <img src="../app/images/images/Hidrolatai8.png" alt = 'Hidrolatas Nr.1'>
                      ...
                      <!-- Prekė Nr. 2 -->
                    <div class="mySlidesfade">
                        <img src="../app/images/images/Hidrolatai7.png" alt = 'Hidrolatas Nr.2'>
                        <div class="price">5 € / 100 ml</div>
                        <div class="buy"> <button class="js-cd-add-to-cart" 
                            data-item-id="2"
                            data-price="5" 
                ...
                <div class="row">
                    <!-- Prekė Nr. 3 -->
                    <div class="mySlidesfade">
                        <img src="../app/images/images/Hidrolatai6.png" alt = 'Hidrolatas Nr. 3'>
                        <div class="price">5 € / 100 ml</div>
                        <div class="buy"> <button class="js-cd-add-to-cart" 
                            data-item-id="3"
                            data-price="5" 
                    ...
                    <!-- Prekė Nr. 4 -->
                      <div class="mySlidesfade">
                          <img src="../app/images/images/Hidrolatai5.png" alt = 'Hidrolatas Nr.4'>
